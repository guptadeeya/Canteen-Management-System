        ...
        try {
          ...
          results.forEach((result, index) => {
            if (responses[index].ok) {
              console.log(
                `Payment ${paymentIds[index]} status updated to success`,
                result
              );
            } else {
              console.error(
                `Error updating payment ${paymentIds[index]} status`
              );
            }
          });
        } catch (error) {
              ...
              <div className="card" style={{ border: "2px solid black" }}>
                ...
                <div>
                  <div className="row" style={{ borderTop: "2px solid black" }}>
                    <div
                      className="col"
                      style={{ textAlign: "right", marginRight: "165px" }}
                    >
